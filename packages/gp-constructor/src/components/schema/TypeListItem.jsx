...
export default class TypeListItem extends React.Component {
  ...
  getActions() {
    ...
    if (this.props.item.get('isDeletable')) {
      actions.push({
        key: 'remove',
        title: 'Удалить',
  ...
  render() {
    const { isSelected, isMain, isGlobal } = this.props;
    ...
    return (
      ...
      >
        ...
        <div className="pull-right">
          {isMain && !isGlobal ? <i className="fa fa-star" title="Главный тип" style={{ color: '#FFDC00' }} /> : ''}
        </div>

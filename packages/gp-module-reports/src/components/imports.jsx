...
import { getReportImport } from '../redux/modules/reports';
...
@connect(
  ...
  { getReports: getReportImport },
)
export default class ImportsView extends Report {
